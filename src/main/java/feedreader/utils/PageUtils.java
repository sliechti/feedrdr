...
public class PageUtils {
    ...
    public static void gotoStart(HttpServletRequest req, HttpServletResponse response) throws IOException {
     ...
     * @param response
     * @throws IOException
     * @deprecated use {@link PageUtils#gotoStart(HttpServletRequest, HttpServletRequest)} instead.
     */
    @Deprecated
