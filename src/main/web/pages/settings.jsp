...
<div class="col-lg-10">
	...
	<div class="col-lg-7" id="content_panel">
		...
		<div id="pro">
			...
			<p>
				<a href="" onclick="showCreateNewProfile(); return false;">Add
					new <span class="glyphicon glyphicon-plus text-right"></span>
				</a>
			</p>
		</div>
				...
				<div class="checkbox">
					<div>
						<label> <input type="checkbox" value="1"
							<%=checkedIfTrue(data.isSubscribedForNewsletter())%>
							name="<%=Constants.CHECKBOX_SUBSCRIPTION_NEWSLETTER%>">Receive
							monthly newsletter on everything related to feedrdr
						</label>
					</div>
					<div>
						<label> <input type="checkbox" value="1"
							<%=checkedIfTrue(data.isSubscribedToUpdates())%>
							name="<%=Constants.CHECKBOX_SUBSCRIPTION_PRODUCT_UPDATES%>">Receive
							weekly updates on new product updates
						</label>

					</div>
				</div>
				<br> <input type="submit" tabindex="8" name="submit"
					value="Save settings" class="btn btn-primary btn">
			</form>
		</div>
	</div>
