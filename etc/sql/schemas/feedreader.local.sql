...
C:\dev\feedrdr.co\etc\tools>pg_dump -U sliechti -n feedreader -s -C postgres 
--
...
ALTER TABLE admins OWNER TO sliechti;
...
ALTER TABLE feedentries OWNER TO sliechti;
...
ALTER TABLE feedentries_l_entry_id_seq OWNER TO sliechti;
...
ALTER TABLE feedentriesdata OWNER TO sliechti;
...
ALTER TABLE feedentriesimages OWNER TO sliechti;
...
ALTER TABLE feedentriesimages_l_image_id_seq OWNER TO sliechti;
...
ALTER TABLE feedentrieslinks OWNER TO sliechti;
...
ALTER TABLE feedentrieslinks_l_link_id_seq OWNER TO sliechti;
...
ALTER TABLE feedsourcechanneldata OWNER TO sliechti;
...
ALTER TABLE feedsourcechannelimage OWNER TO sliechti;
...
ALTER TABLE feedsourcenodes OWNER TO sliechti;
...
ALTER TABLE feedsources OWNER TO sliechti;
...
ALTER TABLE feedsources_l_xml_id_seq OWNER TO sliechti;
...
ALTER TABLE httperrors OWNER TO sliechti;
...
ALTER TABLE httperrors_id_seq OWNER TO sliechti;
...
ALTER TABLE seq_feedsources OWNER TO sliechti;
...
ALTER TABLE sourcecollections OWNER TO sliechti;
...
ALTER TABLE sourcecollections_l_collection_id_seq OWNER TO sliechti;
...
ALTER TABLE sourcecollectionslist OWNER TO sliechti;
...
ALTER TABLE sourcecollectionslist_l_entry_id_seq OWNER TO sliechti;
...
ALTER TABLE userauthtokens OWNER TO sliechti;
...
ALTER TABLE userfeedentriesinfo OWNER TO sliechti;
...
ALTER TABLE userfeedsubscriptions OWNER TO sliechti;
...
ALTER TABLE userfeedsubscriptions_l_subs_id_seq OWNER TO sliechti;
...
ALTER TABLE userkeyvalues OWNER TO sliechti;
...
ALTER TABLE userkeyvalues_l_key_id_seq OWNER TO sliechti;
...
ALTER TABLE userprofiles OWNER TO sliechti;
...
ALTER TABLE userprofiles_l_profile_id_seq OWNER TO sliechti;
...
ALTER TABLE userprofilestreamgroup OWNER TO sliechti;
...
ALTER TABLE users OWNER TO sliechti;
...
ALTER TABLE users_l_user_id_seq OWNER TO sliechti;
...
ALTER TABLE usersavedentries OWNER TO sliechti;
...
ALTER TABLE userstreamgroupfeedsubscription OWNER TO sliechti;
...
ALTER TABLE userstreamgroups OWNER TO sliechti;
...
ALTER TABLE userstreamgroups_l_stream_id_seq OWNER TO sliechti;
...
ALTER TABLE userstreamgroupviewoptions OWNER TO sliechti;
